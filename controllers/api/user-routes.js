...
async function main(email, username) {
  ...
  let transporter = nodemailer.createTransport({
    ...
    auth: {
      user: 'reinhold.mitchell45@ethereal.email', //testAccount.user,  generated ethereal user
      pass: 'gnsa8V9jUXwaQtww77' //testAccount.pass,  generated ethereal password
    },
  });
...
router.post("/", (req, res) => {
  User.create({
    ...
    main(req.body.email, req.body.username ).catch(console.error);
